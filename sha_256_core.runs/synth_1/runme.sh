...
HD_PWD='H:/SHA-256/sha_256_core/sha_256_core.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sha256_parallel_pipelined.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sha256_parallel_pipelined.tcl
